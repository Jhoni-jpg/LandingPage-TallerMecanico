...
export default function HowItWorks() {
    ...
    return (
        <>
            ...
            <section id="comoFunciona" className="bg-gradient-to-b from-white via-blue-50 to-white py-20 mb-40">
                    ...
                    <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                        ...
                        <div className="relative z-10 p-8 md:p-12 text-center">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                                <button onClick={() => setIsChatOpen(true)} className="relative overflow-hidden px-8 py-4 bg-transparent border-2 border-white group-hover:border-transparent text-white font-bold hover:border-none rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 group">
