...
export default function FAQ() {
  ...
  bg-gradient-to-b from-white/100 via-blue-200/20 via-70% to-transparent backdrop-blur-sm" />

      <div className="pointer-events-none absolute bottom-0 left-0 right-0 h-40
  bg-gradient-to-t from-white/100 via-blue-200/20 via-70% to-transparent backdrop-blur-sm" />
