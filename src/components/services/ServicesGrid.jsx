    ...
    const Pagination = ({ page, totalPages, onChange }) => (
        <div className="flex items-center gap-2">
            <button
                ...
                className={`p-2 rounded-full transition-shadow ${page === 0 ? 'bg-gray-200 text-gray-400' : 'bg-white shadow hover:shadow-md'}`}
            >
            ...
            <button
                ...
                className={`p-2 rounded-full transition-shadow ${page === totalPages - 1 ? 'bg-gray-200 text-gray-400' : 'bg-white shadow hover:shadow-md'}`}
            >
